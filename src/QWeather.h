...
/**
 * @brief 按天获取预报的类型，同时请求的数据越多，
 * 对于处理数据的内存也越高。。。所以，能少请求就少请求
 */
...
public:
     ...
     */
    vector<GeoInfo> GetGeoInfoList(String location, String adm = "", 
            String range = "cn", uint8_t maxNumber = 10);
     ...
     */
    vector<DailyWeather> GetDailyWeather(String location, 
                        DailyPredictionType dailyPredictionType = DailyPredictionType::DAY7);
     ...
     */
    vector<HourlyWeather> GetHourlyWeather(String location, 
            HourlyPredictionType hourlyPredictionType = HourlyPredictionType::H24);
     ...
     */
    void Config(String key, String l = "zh", UnitType unitType = UnitType::METRIC, 
            APIVersion apiVersion = APIVersion::DEV);
};
